...
if [ "$commercial" == 1 ]; then
	...
	$SUDO_CMD wget "http://oss.sonatype.org/service/local/artifact/maven/content?c=jar-with-dependencies&r=snapshots&g=com.floragunn&a=dlic-search-guard-module-kibana-multitenancy&v=5.0-1-SNAPSHOT" --content-disposition   -P "$ES_PLUGINS_DIR/search-guard-5"  > /dev/null 2>&1
